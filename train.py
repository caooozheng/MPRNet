...
def main():
    ...
    parser.add_argument("--dataset", type=str, default="LSUI", choices=["UIEB", "LSUI", 'UFO', 'EUVP-s', 'EUVP-d'])
    parser.add_argument("--model_name", type=str, default="MPRNet",help="model name")
