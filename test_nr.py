...
class Tester(object):
    def __init__(self, args):
        ...
        options = get_option(r"model_repos/uranker/URanker.yaml")
        options["model"]["resume_ckpt_path"] = r"model_files/URanker_ckpt.pth"
        ...
        if args.dataset == "CH60":
            ...
            args.test_root = (
                "UnderWaterDataset/EUVP/test/"
            )
        elif args.dataset == "U45":
            args.test_root = "UnderWaterDataset/U45/test/"
